...
export default function Home() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Hero Section */}
      <section className="px-6 min-h-[calc(100vh-5rem)] flex items-center">
        <div className="max-w-6xl ml-[3rem] w-full">
          <div className="flex items-center gap-1.5 mb-3">
            <div className="w-1.5 h-1.5 bg-[#ff6b35] rounded-full animate-pulse"></div>
            <span className="text-[11px] uppercase tracking-widest text-[#9a9a9a] font-mono">VISION</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-[#9a9a9a] mb-4 max-w-3xl font-mono leading-snug">
          ...
          <div className="w-1/2 border-r border-[#2a2a2a]">
            ...
            <div className="py-8 px-6 border-b border-[#2a2a2a]">
              <div className="flex items-start gap-1.5 mb-3">
                ...
                <span className="text-[11px] uppercase tracking-widest text-[#9a9a9a] font-mono">WHAT DAOCHAIN DOES</span>
              </div>
            ...
            <div className="py-8 px-6 border-b border-[#2a2a2a]">
              <div className="flex items-start gap-1.5 mb-3">
                <div className="w-1 h-1 bg-[#ff6b35] rounded-full mt-0.5"></div>
                <span className="text-[11px] uppercase tracking-widest text-[#9a9a9a] font-mono">WHY IT MATTERS</span>
              </div>
              <h2 className="text-3xl font-bold font-mono mb-4 tracking-tight">
                DAOs can now run governance without:
              </h2>
              <div className="space-y-2 text-[#9a9a9a] text-xs font-mono leading-relaxed mb-4">
            ...
            <div id="how-it-works" className="py-8 px-6 scroll-mt-10">
              <div className="flex items-start gap-1.5 mb-3">
                <div className="w-1 h-1 bg-[#ff6b35] rounded-full mt-0.5"></div>
                <span className="text-[11px] uppercase tracking-widest text-[#9a9a9a] font-mono">HOW IT WORKS</span>
              </div>
              <h2 className="text-3xl font-bold font-mono mb-4 tracking-tight">
                How It Works
              </h2>
          ...
          <div className="w-1/2 bg-[#0a0a0a] sticky top-10 self-start overflow-hidden" style={{ maxHeight: 'calc(100vh - 2.5rem)' }}>
            ...
            <div className="p-6 font-mono text-xs custom-scrollbar" style={{ height: 'calc(100vh - 10rem)', overflowY: 'scroll' }}>
              ...
              <div className="border border-[#2a2a2a] bg-black p-4 mb-4">
                <div className="mb-2 text-[#6a6a6a] text-[11px]">orchestrator.ts</div>
      ...
      <section id="architecture" className="py-8 px-6 border-t border-[#2a2a2a] scroll-mt-10 relative overflow-hidden bg-black z-10">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="flex items-start gap-1.5 mb-4">
            <div className="w-1 h-1 bg-[#ff6b35] rounded-full mt-0.5"></div>
            <span className="text-[11px] uppercase tracking-widest text-[#9a9a9a] font-mono">TECHNICAL ARCHITECTURE</span>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <div className="border border-[#2a2a2a] p-5 hover:border-[#ff6b35] transition-colors">
              <h3 className="text-base font-bold font-mono mb-3 text-[#ff6b35]">SUBSTRATE CHAIN</h3>
              <p className="text-[#9a9a9a] text-xs font-mono leading-relaxed mb-3">
            ...
            <div className="border border-[#2a2a2a] p-5 hover:border-[#ff6b35] transition-colors">
              <h3 className="text-base font-bold font-mono mb-3 text-[#ff6b35]">MIXNET LAYER</h3>
              <p className="text-[#9a9a9a] text-xs font-mono leading-relaxed mb-3">
            ...
            <div className="border border-[#2a2a2a] p-5 hover:border-[#ff6b35] transition-colors">
              <h3 className="text-base font-bold font-mono mb-3 text-[#ff6b35]">CLIENT SDKs</h3>
              <p className="text-[#9a9a9a] text-xs font-mono leading-relaxed mb-3">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="border border-[#2a2a2a] p-4 hover:border-[#ff6b35] transition-colors">
              <h4 className="text-xs font-bold font-mono mb-2 text-white">Fully on-chain elections</h4>
              <p className="text-[#9a9a9a] text-[11px] font-mono">All election data and results are stored and verified on the Polkadot blockchain</p>
            </div>
            <div className="border border-[#2a2a2a] p-4 hover:border-[#ff6b35] transition-colors">
              <h4 className="text-xs font-bold font-mono mb-2 text-white">cMix-style verifiable mixnet</h4>
              <p className="text-[#9a9a9a] text-[11px] font-mono">Cryptographically verifiable mixing process ensures ballot anonymity</p>
            </div>
            <div className="border border-[#2a2a2a] p-4 hover:border-[#ff6b35] transition-colors">
              <h4 className="text-xs font-bold font-mono mb-2 text-white">zk-based eligibility proofs</h4>
              <p className="text-[#9a9a9a] text-[11px] font-mono">Zero-knowledge proofs verify voter eligibility without revealing identity</p>
            </div>
            <div className="border border-[#2a2a2a] p-4 hover:border-[#ff6b35] transition-colors">
              <h4 className="text-xs font-bold font-mono mb-2 text-white">Threshold encryption</h4>
              <p className="text-[#9a9a9a] text-[11px] font-mono">Distributed key management prevents single-party ballot decryption</p>
            </div>
            <div className="border border-[#2a2a2a] p-4 hover:border-[#ff6b35] transition-colors">
              <h4 className="text-xs font-bold font-mono mb-2 text-white">Proof-based tally</h4>
              <p className="text-[#9a9a9a] text-[11px] font-mono">Cryptographic proofs ensure tally correctness without exposing votes</p>
            </div>
            <div className="border border-[#2a2a2a] p-4 hover:border-[#ff6b35] transition-colors">
              <h4 className="text-xs font-bold font-mono mb-2 text-white">Open-source standards</h4>
              <p className="text-[#9a9a9a] text-[11px] font-mono">Fully auditable codebase following established cryptographic protocols</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="border-l-2 border-[#ff6b35] pl-4 py-2">
              <h3 className="text-base font-bold font-mono mb-2 text-white">DAOs running governance</h3>
            ...
            <div className="border-l-2 border-[#ff6b35] pl-4 py-2">
              <h3 className="text-base font-bold font-mono mb-2 text-white">Protocols running token-holder votes</h3>
              <p className="text-[#9a9a9a] text-xs font-mono leading-relaxed">
            ...
            <div className="border-l-2 border-[#ff6b35] pl-4 py-2">
              <h3 className="text-base font-bold font-mono mb-2 text-white">Collectives needing anonymous decisions</h3>
              <p className="text-[#9a9a9a] text-xs font-mono leading-relaxed">
            ...
            <div className="border-l-2 border-[#ff6b35] pl-4 py-2">
              <h3 className="text-base font-bold font-mono mb-2 text-white">Communities running fair elections</h3>
              <p className="text-[#9a9a9a] text-xs font-mono leading-relaxed">
      ...
      <section id="docs" className="py-8 px-6 border-t border-[#2a2a2a] scroll-mt-10">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-start gap-1.5 mb-4">
            <div className="w-1 h-1 bg-[#ff6b35] rounded-full mt-0.5"></div>
            <span className="text-[11px] uppercase tracking-widest text-[#9a9a9a] font-mono">QUICKSTART GUIDE</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold font-mono mb-6 tracking-tight">
            Built for Developers
          </h2>
          <div className="mb-6">
            <ul className="space-y-2 text-[#9a9a9a] text-xs font-mono">
          ...
          <div className="bg-[#0a0a0a] border border-[#2a2a2a] p-4 font-mono text-xs mb-4">
            <div className="space-y-2">
              <div>
          ...
          <a 
            href="/sandbox" 
            className="inline-block px-6 py-3 border border-[#ff6b35] text-[#ff6b35] hover:bg-[#ff6b35] hover:text-black font-mono font-bold text-[11px] uppercase tracking-widest transition-colors btn-animated-texture"
          >
            TRY SANDBOX →
          </a>
        </div>
