// DaoChain: governance-focused parachain built from the Polkadot SDK parachain template.
// This is purely informational; do not change any behavior.
...
pub fn local_chain_spec() -> ChainSpec {
	...
	.with_protocol_id("daochain-local")
	.with_properties(properties)
	.build()
}
